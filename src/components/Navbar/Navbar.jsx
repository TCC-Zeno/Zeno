    ...
    <>
      <nav className={styles.navbar}>
          ...
          <ul>
            <Link
              className={`${styles.nav_link} ${
                rotaStatus == "dashboard" ? styles.active : null
              }`}
              to="/dashboard"
            >
            ...
            <Link
              className={`${styles.nav_link} ${
                rotaStatus == "stock" ? styles.active : null
              }`}
              to="/stock"
            >
            ...
            <Link
              className={`${styles.nav_link} ${
                rotaStatus == "finance" ? styles.active : null
              }`}
              to="/finance"
            >
            ...
            <Link
              className={`${styles.nav_link} ${
                rotaStatus == "calendar" ? styles.active : null
              }`}
              to="/calendar"
            >
            ...
            <Link
              className={`${styles.nav_link} ${
                rotaStatus == "list" ? styles.active : null
              }`}
              to="/list"
            >
            ...
            <Link
              className={`${styles.nav_link} ${
                rotaStatus == "report" ? styles.active : null
              }`}
              to="/report"
            >
            ...
            <Link
              className={`${styles.nav_link} ${
                rotaStatus == "service" ? styles.active : null
              }`}
              to="/service"
            >
            ...
            <Link
              className={`${styles.nav_link} ${
                rotaStatus == "settings" ? styles.active : null
              }`}
              to="/settings"
            >
        ...
        <div className={styles.help}>
          <Link
            className={`${styles.nav_link} ${
              rotaStatus == "support" ? styles.active : null
            }`}
            to="/support"
          >
        ...
        {/* <button onClick={showNavbar}>
          <TfiMenu className={styles.menuClose} />
        </button>
        <button onClick={showNavbar}>
          <AiOutlineDoubleLeft className={styles.menu} />
        </button> */}
      </nav>
    </>
  );
